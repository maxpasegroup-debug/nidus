  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { title: "How We Use Information", text: "Information is used to manage admissions, learning access, assessments, exam coaching sessions, NIDUS Guru guidance, mentoring, reports, communication, payments, support, and safety of the platform." },
