    ...
    <main className="relative min-h-screen overflow-hidden bg-[#f7f3ea] px-4 pb-16 pt-28 text-[#101827] sm:px-6 lg:px-8">
      ...
      <div className="relative mx-auto grid min-h-[calc(100vh-10rem)] max-w-7xl gap-10 lg:grid-cols-[1fr_29rem] lg:items-center">
        <section className="max-w-3xl">
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-[#3f4a32]">Secure Academy Access</p>
          <h1 className="mt-5 text-4xl font-semibold leading-tight text-[#071d36] sm:text-6xl">Continue your NIDUS journey.</h1>
        ...
        <section className="relative overflow-hidden rounded-lg border border-[#071d36]/10 bg-white/86 p-6 shadow-[0_28px_90px_rgba(7,29,54,0.12)] backdrop-blur-2xl sm:p-8">
          ...
          <div className="mb-8 flex items-start justify-between gap-4">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.24em] text-[#3f4a32]">NIDUS</p>
              <h2 className="mt-3 text-3xl font-semibold text-[#071d36]">Login / Signup</h2>
              <p className="mt-2 text-sm text-[#64748b]">Use your assigned credentials to continue.</p>
            </div>
            <div className="rounded-full border border-[#b9913f]/30 bg-[#f7f3ea] p-3">
              <BrainCircuit className="h-6 w-6 text-[#3f4a32]" />
            </div>
          </div>
