  ...
  return (
    <main className="min-h-screen px-4 py-6 sm:px-6 lg:px-8">
      <section className="mx-auto max-w-7xl">
        <div>
          <p className="text-xs uppercase tracking-[0.28em] text-gold-soft">CEO System Configuration</p>
          <h1 className="mt-3 text-3xl font-semibold text-ink">System Settings</h1>
          <p className="mt-2 text-sm text-muted">App, branding, email, and security controls for CEO governance.</p>
        </div>
        <div className="mt-6">
