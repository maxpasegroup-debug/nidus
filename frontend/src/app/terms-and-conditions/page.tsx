  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { title: "Programs and Subscriptions", text: "Program access, batch timing, mentor support, assessment access, TOPRANK access, and NIDUS Guru quests may vary by plan, eligibility, payment status, and academy approval." },
