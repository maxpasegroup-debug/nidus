...
export default function TeacherDashboardPage() {
  ...
  const selectedCalendarItem =
    calendar.find((item) => item.id === selectedCalendarId) ??
    calendar.find((item) => item.batchId === selectedClass?.id) ??
    calendar[0] ??
    null;
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-5 sm:px-6 lg:px-8">
      ...
      <section id="today" className="rounded-2xl border border-[var(--border)] bg-white p-5 shadow-sm">
      ...
      <section id="classes" className="mt-6 rounded-2xl border border-[var(--border)] bg-white p-5 shadow-sm">
      ...
      <section id="exams" className="mt-6 rounded-2xl border border-[var(--border)] bg-white p-5 shadow-sm">
      ...
      <section id="assignments" className="mt-6 rounded-2xl border border-[var(--border)] bg-white p-5 shadow-sm">
      ...
      <section id="attendance" className="mt-6 rounded-2xl border border-[var(--border)] bg-white p-5 shadow-sm">
        <SectionHeader eyebrow="Attendance" title="Mark present and absent" description="Select program and batch above, then mark each student with comments if needed." icon={<ClipboardCheck size={20} />} />
      ...
      <section id="library" className="mt-6 rounded-2xl border border-[var(--border)] bg-white p-5 shadow-sm">
      ...
      <section id="academic-calendar" className="mt-6 rounded-2xl border border-[var(--border)] bg-white p-5 shadow-sm">
        ...
        <div className="mt-5 grid gap-4 lg:grid-cols-[1fr_360px]">
          <div className="grid gap-3 md:grid-cols-2">
            ...
            {!calendar.length ? <EmptyState text="No timetable or syllabus plan is assigned yet." /> : null}
          </div>
