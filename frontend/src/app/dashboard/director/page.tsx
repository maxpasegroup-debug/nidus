...
const directorAreas: DirectorArea[] = [
  {
    ...
    subAreas: [
      { title: "Programs & Courses", text: "Manage Academy programs and course structure.", href: "/programs", icon: BookOpen },
      ...
      { title: "Exams & Tests", text: "Create, approve, publish and monitor exams.", href: "/examination-center", icon: ClipboardCheck },
      { title: "Study Materials", text: "Control notes, recorded classes and batch library.", href: "/media-library", icon: FileArchive },
      { title: "Student Progress", text: "Review batch-wise and student-wise academic progress.", href: "/performance-analytics", icon: PieChart },
    ],
  },
  {
    ...
    subAreas: [
      { title: "New Enquiries", text: "Website, WhatsApp, calls, social media and walk-in leads.", href: "/crm/leads", icon: MessageCircle },
      { title: "Applications", text: "Students who applied for Academy programs.", href: "/crm/admissions", icon: FileText },
      { title: "Counselling", text: "Parent discussion, student needs and course suggestions.", href: "/crm/counselling", icon: Users },
      ...
      { title: "Fee Follow-Up", text: "Pending fee reminders and payment coordination.", href: "/fees", icon: BadgeIndianRupee },
      { title: "Documents", text: "Student documents, ID proof and academic details.", href: "/documents", icon: FileArchive },
      { title: "Admission Reports", text: "Course-wise admissions and conversion status.", href: "/crm", icon: BarChart3 },
    ],
  },
  {
    ...
    subAreas: [
      ...
      { title: "Creative Library", text: "Posters, videos, brochures and reels.", href: "/media-library", icon: FileArchive },
      ...
      { title: "Campaign Leads", text: "Track campaign-wise leads and source quality.", href: "/crm/leads", icon: UserPlus },
      { title: "Marketing Reports", text: "Reach, engagement, conversion and best creatives.", href: "/performance-analytics", icon: BarChart3 },
    ],
  },
  {
    title: "HRM",
    ...
    subAreas: [
      ...
      { title: "Attendance & Leave", text: "Staff attendance, leave and approvals.", href: "/staff-hr", icon: CalendarDays },
      { title: "Performance Review", text: "Class completion, student feedback and staff output.", href: "/performance-analytics", icon: PieChart },
  ...
  },
  {
    ...
    subAreas: [
      { title: "Fee Management", text: "Course fees, student payments and pending dues.", href: "/fees", icon: BadgeIndianRupee },
      { title: "Invoices & Receipts", text: "Generate and track payment receipts.", href: "/invoices", icon: ReceiptText },
      { title: "Expenses", text: "Office, salary, rent, marketing and operations.", href: "/payments", icon: CreditCard },
      { title: "Subscriptions", text: "TOPRANK, assessments and premium module subscriptions.", href: "/subscriptions", icon: WalletCards },
      { title: "Reports", text: "Academic, admissions, marketing, finance and staff reports.", href: "/performance-analytics", icon: BarChart3 },
      { title: "Settings", text: "Company details, contact number and system controls.", href: "/dashboard/settings", icon: Settings },
      { title: "Audit Logs", text: "Track important staff and management actions.", href: "/admin-center/audit-logs", icon: FileText },
    ],
  },
];
