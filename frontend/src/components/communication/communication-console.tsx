    ...
    <motion.div className="space-y-7" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      <section className="flex flex-col justify-between gap-4 border-b border-white/10 pb-5 lg:flex-row lg:items-end">
        <div>
          ...
          <p className="mt-3 max-w-2xl text-sm leading-6 text-muted">Enterprise notifications, secure internal conversations, institutional announcements, Brevo email delivery and push-ready structure.</p>
        </div>
      ...
      {view === "thread" ? (
        <section className="grid gap-4 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          <Card className="p-5">
            ...
            <p className="mt-2 text-xs text-muted">Typing indicator placeholder active</p>
