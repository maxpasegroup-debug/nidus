    ...
    <header className="fixed left-0 right-0 top-0 z-50 border-b border-[#071D36]/8 bg-[#f7f3ea]/78 text-[#071D36] backdrop-blur-2xl">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden items-center gap-2 lg:flex">
          <Link href="/start-free" className="inline-flex min-h-10 items-center justify-center rounded-full border border-[#071D36]/14 bg-white/76 px-4 py-2 text-sm font-semibold text-[#071D36] shadow-sm transition hover:bg-white">
            Start Free
          </Link>
