...
const directorMenu: DirectorMenuItem[] = [
  ...
  },
  {
    ...
    icon: GraduationCap,
    match: ["/dashboard/director/academic", "/dashboard/director/exams", "/dashboard/director/teaching/classes", "/dashboard/director/teaching/assignments", "/dashboard/director/teaching/academic-calendar", "/examination-center"],
    children: [
