...
export function MyWorkspace({ role }: { role: WorkspaceRole }) {
  ...
  const teacherTools = useMemo<WorkspaceTool[]>(() => [
    { title: "My Classes", description: "Open assigned classes, subjects and daily class work.", icon: Users, href: `${base}/my-classes`, label: "Classroom", primary: true },
    { title: "Attendance", description: "Mark class attendance and review registers.", icon: CalendarCheck, href: `${base}/attendance?action=mark-attendance`, label: "Register", primary: true },
    { title: "NDP / Marks", description: "Enter term exam marks and student progress notes.", icon: ClipboardCheck, href: `${base}/ndp`, label: "Progress", primary: true },
    {
      title: "Homework",
    ...
    { title: "Exams", description: "Create tests, manage exam history and review results.", icon: BookOpenCheck, href: `${base}/exams`, label: "Exam", primary: true },
    {
