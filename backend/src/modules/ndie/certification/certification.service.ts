  ...
  async health() {
    ...
    return {
      ...
      realReleaseArchive: {
        ...
        bundleVerified: realReleaseArchive.bundleVerified,
        sealPlanned: realReleaseArchive.sealPlanned,
        sealed: realReleaseArchive.sealed,
        overwriteProtected: realReleaseArchive.overwriteProtected,
        snapshotId: realReleaseArchive.snapshotId,
        certificationState: realReleaseArchive.certificationState,
        signoffStatus: realReleaseArchive.signoffStatus,
        archiveManifestSha256: realReleaseArchive.archiveManifestSha256,
        sealSha256: realReleaseArchive.sealSha256,
      ...
      realCertificationSuite: {
        ...
        suiteRunId: realCertificationSuite.suiteRunId,
        mode: realCertificationSuite.mode,
        state: realCertificationSuite.state,
        ...
        blockingFailures: realCertificationSuite.blockingFailures,
        evidenceReadinessPercent: realCertificationSuite.evidenceReadinessPercent,
        snapshotId: realCertificationSuite.snapshotId,
        packageSha256: realCertificationSuite.packageSha256,
        dossierSha256: realCertificationSuite.dossierSha256,
        integrity: realCertificationSuite.integrity,
        archive: realCertificationSuite.archive,
        readyToWriteProductionArchive: realCertificationSuite.readyToWriteProductionArchive,
        nextRequiredAction: realCertificationSuite.nextRequiredAction,
