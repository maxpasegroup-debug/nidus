...
const transitions: Record<NdieJobState, NdieJobState[]> = {
  ...
  PROCESSING: ["RENDERING", "OCR_RUNNING", "LAYOUT_RUNNING", "FORMULA_RUNNING", "VISUAL_RUNNING", "QUESTION_RUNNING", "ANSWER_RUNNING", "WAITING_FOR_PROVIDER", "COMPLETED", "FAILED", "RETRY_PENDING", "CANCELLED"],
  ...
  READY_FOR_AI_VALIDATION: ["COMPLETED", "REPLAY_PENDING"],
