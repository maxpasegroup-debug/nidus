...
const transitions: Record<NdieJobState, NdieJobState[]> = {
  ...
  PROCESSING: ["RENDERING", "OCR_RUNNING", "LAYOUT_RUNNING", "WAITING_FOR_PROVIDER", "COMPLETED", "FAILED", "RETRY_PENDING", "CANCELLED"],
  ...
  READY_FOR_FORMULA_ENGINE: ["COMPLETED", "REPLAY_PENDING"],
