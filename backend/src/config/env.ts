...
const envSchema = z.object({
  ...
  CORS_ORIGIN: z.string().default("https://nidusacademy.com,https://nidusacademy.in"),
  FRONTEND_APP_URL: z.string().url().default("https://nidusacademy.com"),
  BACKEND_PUBLIC_URL: z.string().url().default("https://api.nidusacademy.com"),
  APP_DOMAIN: z.string().default("nidusacademy.com"),
