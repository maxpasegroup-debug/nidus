...
const envSchema = z.object({
  ...
  NDIE_IMPORT_WORKER_POOL: z.coerce.number().int().positive().max(50).default(2),
  NDIE_REPLAY_WORKER_POOL: z.coerce.number().int().positive().max(25).default(1),
  NDIE_PUBLISH_WORKER_POOL: z.coerce.number().int().positive().max(25).default(1),
  NDIE_DELIVERY_WORKER_POOL: z.coerce.number().int().positive().max(25).default(1),
  NDIE_WORKER_HEARTBEAT_TTL_MS: z.coerce.number().int().positive().default(90000),
  NDIE_BACKPRESSURE_MAX_QUEUED: z.coerce.number().int().positive().default(250),
  NDIE_BACKPRESSURE_MAX_PROCESSING: z.coerce.number().int().positive().default(50),
  NDIE_CACHE_ENABLED: envBoolean(true),
  NDIE_CACHE_TTL_SECONDS: z.coerce.number().int().positive().default(86400),
  NDIE_MAX_DOCUMENT_PAGES: z.coerce.number().int().positive().max(2000).default(1000),
  NDIE_MALWARE_SCANNING_ENABLED: envBoolean(false),
  NDIE_QUARANTINE_ENABLED: envBoolean(true),
  NDIE_RETENTION_DAYS: z.coerce.number().int().positive().default(2555),
  NDIE_LEGAL_HOLD_ENABLED: envBoolean(false),
  NDIE_WORKER_SHARED_SECRET: z.string().default(""),
  NDIE_SIGNED_ASSET_TTL_SECONDS: z.coerce.number().int().positive().default(3600),
